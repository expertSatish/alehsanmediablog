...
class SubcategoryCantroller extends Controller
{
    public function index()
    {
 
        $categories = Category::whereNotIn('parent_id',[0])->latest()->paginate(5);
    ...
    public function create()
    {
        try{
            ...
            return response()->json([
                "success" => true,
                "html" => view('admin.subcategory.ajax.create',compact('language','firstcategory'))->render(),
            ]);
        }
        catch(\Exception $ex){
            return response()->json([
        ...
        if ($validator->passes()) {
            ...
            try {
                ...
                $category = Category::create([
                    ...
                    'parent_id' => $request->selectedcategory ?? Null,
                    'name' => $request->name,
                    'url' => $request->url,
                    'image'=>$filename,
    ...
    public function edit($id)
    {
        try {
            ...
            return response()->json([
                "success" => true,
                "html" => view('admin.subcategory.ajax.edit')->with([
                    'category' => $category,
                    'language' => $language,
    ...
    public function show($id)
    {
        ...
        return view('admin.subcategory.children')->with([
