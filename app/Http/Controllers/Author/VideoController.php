...
class VideoController extends Controller
{
    public function index()
    {
        ...
        $Videos = Video::where('author_id',auth()->user()->id)->latest()->paginate(5);
        // dd($categories);
        return view('author.videos.index')->with([
            'videos' => $Videos
        ]);
    }
    public function create()
    {
        ...
        try{
            return response()->json([
                "success" => true,
                "html" => view('author.videos.ajax.create')->render(),
            ]);
        }
        catch(\Exception $ex){
            return response()->json([
    ...
    public function edit($id)
    {
        try {
            ...
            return response()->json([
                "success" => true,
                "html" => view('author.videos.ajax.edit')->with([
                    'video' => $Video
                ])->render(),
            ]);
        } catch(\Exception $ex){
