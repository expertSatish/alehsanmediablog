...
class ArticalhindiController extends Controller
{
    public function index()
    {
        
        $Artical = Artical::where('language_id',1)->latest()->paginate(2);
        return view('author.articalshindi.index')->with([
            'articals' => $Artical
        ]);
    }
    ...
    public function create()
    {
        try{
            ...
            return response()->json([
                "success" => true,
                "html" => view('author.articalshindi.ajax.create',compact('categoriesd'))->render(),
            ]);
        }
        catch(\Exception $ex){
            return response()->json([
    ...
    public function edit($id)
    {
        ...
        try {
            ...
            return response()->json([
                "success" => true,
                "html" => view('author.articalshindi.ajax.edit')->with([
                    'artical' => $artical,
