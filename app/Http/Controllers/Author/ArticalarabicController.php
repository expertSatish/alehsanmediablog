...
class ArticalarabicController extends Controller
{
    public function index()
    {
        
        $Artical = Artical::where('language_id',4)->latest()->paginate(5);
        return view('author.articalsarabic.index')->with([
            'articals' => $Artical
        ]);
    }
    public function create()
    {
        try{
            ...
            return response()->json([
                "success" => true,
                "html" => view('author.articalsarabic.ajax.create',compact('categoriesd'))->render(),
            ]);
        }
        catch(\Exception $ex){
            return response()->json([
    ...
    public function edit($id)
    {
        try {
            ...
            return response()->json([
                "success" => true,
                "html" => view('author.articalsarabic.ajax.edit')->with([
                    'artical' => $artical,
