...
<section class="hero__banner__section">
    <div class="container">
        <div class="hero__banner">
            <h3 class="font-gilroy-bold mb-3 fs-1 text-primary">English Articles</h3>
...
<section class="post-section py-md-5 mt-4">
    <div class="container">
        <div class="row g-5">
            ...
            @foreach ($englisharticals as $key => $article)
    ...
    <div class="col-12 col-md-6 col-lg-4 col-xl-3">
        <div class="post__listing__card">
            ...
            <div class="post__listing__card__content english">
                <a href="{{ route('articals',$article->url)}}">
    ...
    <ul class="pagination pagination-lg">
        {{ $englisharticals->links('pagination::bootstrap-4') }}
    </ul>
</div>
</section>
...
<!-- Related Articals -->
@php
$mostviews = App\Models\Artical::with('user')->where('language_id','2')->where('status','active')->where('aproved','active')->orderBy('viewd', 'desc')->limit(3)->get();
@endphp
            ...
            <div class="col-12 col-lg-12 col-xl-9">
                ...
                <div class="col-12 col-lg-5">
                    <div class="medium-cards-container">
                        ...
                        <div class="post-content english [ d-flex flex-column justify-content-between ]">
                            <div class="post-auth-date [ d-flex ]">
                                <ul class="d-flex">
                                    <li>
...
<section class="post-section py-md-5">
    <div class="container">
        ...
        @elseif($key >= 3 && $key < 7) <div class="col-12 col-lg-6">
            <div class="small-cards-container">
                <div class="post-content english [ d-flex justify-content-between flex-column  ]">
                    <a href="{{ route('articals',$artical->url)}}">
                        <h4>{{$artical->title}}</h4>
                    </a>
                    <div class="post-auth-date [ d-flex ]">
