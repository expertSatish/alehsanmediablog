    ...
    <main class="main-content">
        <div class="container-fluid photos">
            <div class="row align-items-stretch">
                ...
                <div class="col-sm-4  aos-init" data-aos="fade-up" data-aos-delay="">
                    <a href="{{url('/get-all-album_images/'.$res->id)}}" class="d-block photo-item">
                        <img src="{{url('/storage/album_image/'.$res->album_image)}}" alt="Image">
                        <div class="photo-text-more">
                            <div class="photo-text-more">
                                <h3 class="heading">{{$res->title}}</h3>
                            </div>
                        </div>
                    </a>
                </div>
...
<section class="post-section p-md-5">
    <div class="container">
        ...
        <img src="{{url('/storage/add_image/'.$ads01->add_image02)}}">
