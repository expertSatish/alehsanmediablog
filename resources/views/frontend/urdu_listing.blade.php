...
<section class="post-section py-md-5 mt-4">
    <div class="container">
        <div class="row g-5">
            ...
            @foreach ($articalurdus as $key => $article)
    ...
    <ul class="pagination pagination-lg">
        {{ $articalurdus->links('pagination::bootstrap-4') }}
    </ul>
</div>
</section>
...
<!-- Related Articals -->
@php
$mostviews = App\Models\Artical::with('user')->where('language_id','3')->where('status','active')->where('aproved','active')->orderBy('viewd', 'desc')->limit(3)->get();
@endphp
