...
<section class="hero__banner__section">
    <div class="container">
        <div class="hero__banner">
            <h3 class="font-gilroy-bold mb-3 fs-1 text-primary">Hindi Articles</h3>
...
<section class="post-section py-md-5 mt-4">
    <div class="container">
        <div class="row g-5">
            ...
            @foreach ($hindiharticals as $key => $article)
    ...
    <ul class="pagination pagination-lg">
        {{ $hindiharticals->links('pagination::bootstrap-4') }}
    </ul>
</div>
</section>
...
<!-- Related Articals -->
@php
$mostviews = App\Models\Artical::with('user')->where('status','active')->where('aproved','active')->where('language_id','1')->orderBy('viewd', 'desc')->limit(3)->get();
@endphp
