    ...
    <div class="app-content content container-fluid">
        ...
        <div class="content-wrapper">
            ...
            <div class="tab-content border px-3 ">
                ...
                <form class="py-5" action="{{ route('changepasswordauthor') }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                    ...
                    <form class="py-5" method="post" action="" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="text-danger" id="image-err"></div>
                                ...
                                <div class="m-2"><img src="{{ asset('storage/profile_photo/'.$user->profile_photo) }}"height="50"> </div>
                                @endif
                            </div>
            ...
            $(document).on("click", "#updateuser", function(event) {
              //  for (instance in CKEDITOR.instances) {
               ...
               // }
                ...
                formData.append('profile_photo', (typeof $('#image')[0].files[0] == 'undefined') ? '' : $('#image')[0].files[0]);
                ...
                $.ajax({
                    url: "{{ URL::to('author/profile-setting') }}",
                    type: 'POST',
                    processData: false,
                    contentType: false,
                    dataType: 'json',
