...
<a href="javascript:void(0)" class="add-artical-urdu btn text-dark"><i class="fa fa-plus"></i> Add </a>
...
<a href="javascript:void(0)" class="edit-artical-urdu text-dark mr-2" artical_id="{{ $artical->id }}" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>
...
$.ajax({
url: `{{ URL::to('author/manage-artical-urdu/${id}') }}`,
type: "DELETE",
dataType: "json",
...
$(document).on("click", ".add-artical-urdu", function(event) {
$.ajax({
url: "{{ URL::to('author/manage-artical-urdu/create') }}",
type: "GET",
dataType: "json",
success: function(result) {
if (result.success) {
...
$(document).on("click", "#add-artical-urdu-btn", function(event) {
...
$.ajax({
url: "{{ URL::to('author/manage-artical-urdu') }}",
type: 'POST',
processData: false,
contentType: false,
dataType: 'json',
...
$(document).on("click", ".edit-artical-urdu", function(event) {
let id = $(this).attr('artical_id');
 
$.ajax({
url: `{{ URL::to('author/manage-artical-urdu/${id}/edit') }}`,
type: "get",
dataType: "json",
success: function(result) {
if (result.success) {
...
$(document).on("click", "#update-artical-urdu-btn", function(event) {
//for (instance in CKEDITOR.instances) {
//CKEDITOR.instances[instance].updateElement();
//}
$(this).attr('disabled', true);
...
$.ajax({
url: `{{ URL::to('author/manage-artical-urdu/${artical_id}') }}`,
type: 'POST',
processData: false,
contentType: false,
dataType: 'json',
