            ...
            <div class="modal-body">
                ...
                <div class="row border m-1 p-2 bg-light">
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Meta Title" name="meta_title" id="meta_title" maxlength="60" value="{{$blog->meta_title ?? null }}">
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <textarea class="form-control" rows="4" cols="7" placeholder="Enter Meta Description" name="meta_description" id="meta_description" maxlength="160">{{$blog->meta_description ?? null }}</textarea>
