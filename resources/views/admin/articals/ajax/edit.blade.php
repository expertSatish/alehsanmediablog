            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    <div class="col-sm-12">
                        ...
                        <select class="form-control" name="language_id" id="language_id">
                            ...
                            <option value="{{$languag->id}}" @if ($artical->language_id == $languag->id)
                                selected="selected" @endif>{{$languag->name}}</option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="col-sm-6">
                    ...
                    <select class="form-control" name="category" id="category">
                        ...
                        <option value="{{ $categorie->id }}" @if ($categorie->id == $artical->category_id)
                            selected="selected" @endif>{{ $categorie->name }}</option>
                        @endforeach
                    </select>
                    <div class="text-danger" id="category-err"></div>
                </div>
                ...
                <div class="col-sm-6">
                    ...
                    <select class="form-control" name="author_id" id="author_id">
                        ...
                        <option value="{{$author->id}}" @if(old('author_id')==$author->id) selected
                            @elseif($artical && $artical->author_id == $author->id) selected @endif>{{$author->name}}
                        </option>
                        @endforeach
                    </select>
                </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12">
                ...
                <textarea class="form-control" name="content" id="content" cols="30"
                    rows="10">{{ $artical->content }}</textarea>
        ...
        <div class="row border m-1 p-2 bg-light">
            ...
            <div class="col-md-12 form-group">
                ...
                <input type="text" class="form-control" placeholder="Enter Meta Title" name="meta_title" id="meta_title"
                    maxlength="60" value="{{$artical->meta_title ?? null }}">

                <strong class="note-span small" id="meta_title-limit">We recommend title between 50–60 characters.(0
                    character)</strong>
            ...
            <div class="col-md-12 form-group">
                ...
                <textarea class="form-control" rows="4" cols="7" placeholder="Enter Meta Keywords" name="meta_keyword"
                    id="meta_keyword">{{$artical->meta_keyword ?? null }}</textarea>
            ...
            <div class="col-md-12 form-group">
                ...
                <textarea class="form-control" rows="4" cols="7" placeholder="Enter Meta Description"
                    ...
                    maxlength="160">{{$artical->meta_description ?? null }}</textarea>

                <strong class="note-span small" id="meta_description-limit">We recommend descriptions between 50–160
...
<div class="modal-footer">
    ...
    <button type="button" class="btn btn-primary" id="update-artical-btn"
        artical_id="{{ $artical->id }}">Submit</button>
