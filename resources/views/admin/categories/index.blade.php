        ...
        <div class="content-wrapper ">
            <div class="breadcrumbs-top d-flex align-items-center bg-light mb-3">
                ...
                <div class="add-back ml-auto mr-2">
                    ...
                    <a href="javascript:void(0)" id="add-category" class="btn text-dark" title="Add Category"><i
                            ...
                            @foreach ($categories as $category)
                                ...
                                <td>{{ $category->url }}</td>
                                    ...
                                    <td class="text-truncate">
                                        ...
                                        <!--<a href="{{ route('admin.manage-category.show', $category->id) }}" class="text-success mr-2" title="Add Subcategory"><i class="fa fa-plus" aria-hidden="true"></i></a>-->
