                ...
                <div class="form-group row">
                 ...
                 {{-- <div class="col-md-6 form-group">
                        ...
                        <select class="form-control" name="language_id" id="language_id">
                         ...
                         <option value="{{$languag->id}}" @if ($category->language_id == $languag->id) selected="selected" @endif>{{$languag->name}}</option>
                            @endforeach
                        </select>
                          <div class="text-danger validation-err" id="language_id-err"></div>
                    </div> --}}
                    ...
                    <div class="col-md-12 form-group">
                     ...
                     {{-- <div class="col-md-6 form-group">
                        <label class="label-control label">Menu <span class="required">*</span></label>
                        ...
                        <div class="text-danger validation-err" id="menu-err"></div>
                    </div> --}}
