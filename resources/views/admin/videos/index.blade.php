...
$.ajax({
url: `{{ URL::to('admin/manage-video/${id}') }}`,
type: "DELETE",
dataType: "json",
...
$.ajax({
url: "{{ URL::to('admin/manage-video/create') }}",
type: "GET",
dataType: "json",
success: function(result) {
if (result.success) {
...
$.ajax({
url: `{{ URL::to('admin/manage-video/${id}/edit') }}`,
type: "get",
dataType: "json",
success: function(result) {
if (result.success) {
...
$.ajax({
url: `{{ URL::to('admin/manage-video/${video_id}') }}`,
type: 'POST',
processData: false,
contentType: false,
dataType: 'json',
