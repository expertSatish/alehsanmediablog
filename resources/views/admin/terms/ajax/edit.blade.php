<div class="modal-dialog">
    ...
    <div class="modal-content">
        <form class="form form-horizontal" method="POST" action="{{ route('admin.manage-terms.update', $term->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="modal-body">
                <div class="form-group row">
                    ...
                    <textarea class="form-control" name="content" id="content" cols="30" rows="10">{{ $term->content }}</textarea>
